...
class DAO {
    ...
    static insertOrderShop(connection, {data}) {
        return mysql.createTransactionalQuery({
            query: `INSERT INTO ${this.TABLE_NAME_ORDER}
                    SET ?;`,
            params: [data],
            connection
        })
    ...
    static insertOrderList(connection, {data}) {
        return mysql.createTransactionalQuery({
            query: `INSERT INTO ${this.TABLE_NAME_ORDER_LIST}
                    SET ?;`,
            params: [data],
            connection
        })
